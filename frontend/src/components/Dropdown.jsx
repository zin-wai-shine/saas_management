          ...
          <div className="py-1 max-h-60 overflow-auto">
            {options.map((option) => (
              <button
                ...
                className={`w-full text-left px-4 py-2 text-sm text-white hover:bg-gray-700/40 transition-all ${
                  value === option.value ? 'bg-teal-glass/20 text-teal-glass border-l-2 border-teal-glass' : ''
                }`}
              >
                {option.label}
              </button>
